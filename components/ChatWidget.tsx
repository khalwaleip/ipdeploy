  ...
  return (
    <div className="fixed bottom-14 right-8 z-50 flex flex-col items-end pointer-events-none">
      ...
      <button
        ...
        className="pointer-events-auto flex flex-col items-center group relative animate-bounce-short transition-all hover:scale-110 active:scale-95"
      >
        ...
        <div className="bg-legal-gold text-legal-900 rounded-2xl p-5 shadow-2xl border-4 border-legal-900 relative">
